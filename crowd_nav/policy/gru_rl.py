...
class ValueNetwork1(nn.Module):
    def __init__(self, input_dim, self_state_dim, mlp_dims, gru_hidden_dim):
        super().__init__()
...
class ValueNetwork2(nn.Module):
    def __init__(self, input_dim, self_state_dim, mlp1_dims, mlp_dims, gru_hidden_dim):
        super().__init__()
        self.self_state_dim = self_state_dim
        self.gru_hidden_dim = gru_hidden_dim
...
class GruRL(MultiHumanRL):
    ...
    def configure(self, config):
        ...
        logging.info('Policy: {}GRU-RL {} pairwise interaction module'.format(
